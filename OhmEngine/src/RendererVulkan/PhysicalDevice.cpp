...
namespace OHE
{
    ...
    void PhysicalDevice::CreateLogicalDevice(bool enableValidationLayers)
    {
    ...
    void PhysicalDevice::CreateSwapChain()
    {
    ...
    void PhysicalDevice::DestroySwapChain()
    {
        vkDestroySwapchainKHR(device, swapChain, nullptr);
    }

    void PhysicalDevice::CreateImageViews()
    {
    ...
    void PhysicalDevice::DestroyImageViews()
    {
    ...
    void PhysicalDevice::CreateGraphicsPipeline()
    {
        std::vector<char> vertShaderCode = ReadFile("Shaders/MyShader.vert.spv");
        std::vector<char> fragShaderCode = ReadFile("Shaders/MyShader.frag.spv");

        VkShaderModule vertShaderModule = PhysicalDevice::CreateShaderModule(vertShaderCode);
        VkShaderModule fragShaderModule = PhysicalDevice::CreateShaderModule(fragShaderCode);
    ...
    VkShaderModule PhysicalDevice::CreateShaderModule(const std::vector<char> &code)
    {
    ...
    void PhysicalDevice::DestroyGraphicsPipeline()
    {
    ...
    void PhysicalDevice::CreateRenderPass()
    {
    ...
    void PhysicalDevice::CreateFramebuffers()
    {
    ...
    void PhysicalDevice::DestroyFramebuffers()
    {
    ...
    void PhysicalDevice::CreateCommandPool()
    {
    ...
    void PhysicalDevice::DestroyCommandPool()
    {
        vkDestroyCommandPool(device, commandPool, nullptr);
    }

    void PhysicalDevice::CreateCommandBuffer()
    {
    ...
    void PhysicalDevice::RecordCommandBuffer(VkCommandBuffer commandBuffer, uint32_t imageIndex)
    {
    ...
    void PhysicalDevice::CreateSyncObjects()
    {
    ...
    void PhysicalDevice::CleanupSyncObjects()
    {
        for (size_t i = 0; i < MAX_FRAMES_IN_FLIGHT; i++)
        {
    ...
    void PhysicalDevice::DrawFrame()
    {
        ...
        PhysicalDevice::RecordCommandBuffer(commandBuffers[currentFrame], imageIndex);
