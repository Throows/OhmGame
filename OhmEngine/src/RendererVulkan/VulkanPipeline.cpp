...
namespace OHE {
    ...
    VulkanPipeline::VulkanPipeline(VkDevice &device, const std::string &vertFile, const std::string &fragFile)
        : device(device), vertFile(vertFile), fragFile(fragFile)
    {
    }
    ...
    {
        std::vector<char> vertShaderCode = VulkanPipeline::ReadFile(this->vertFile);
        std::vector<char> fragShaderCode = VulkanPipeline::ReadFile(this->fragFile);
